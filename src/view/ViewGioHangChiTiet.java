...
public class ViewGioHangChiTiet extends javax.swing.JFrame {
    ...
    public ViewGioHangChiTiet() {
        initComponents();
        chiTietService = new GioHangChiTietService();
        dtm = (DefaultTableModel) tblRow.getModel();
        String[] header = {"IdGHCT", "IdGH", "IdCTSP", "Số Lượng", "Đơn Giá", "Ngày Lập", "Ngày Sửa", "Trạng Thái"};
    ...
    private void initComponents() {
        ...
        txtGHCT = new javax.swing.JTextField();
        ...
        setTitle("QUẢN LÝ GIỎ HÀNG CHI TIẾT");

        jLabel1.setText("IdGHCT");

        txtGHCT.setEditable(false);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(35, 35, 35)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtGHCT, javax.swing.GroupLayout.DEFAULT_SIZE, 102, Short.MAX_VALUE)
                            .addComponent(txtGH)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(txtGHCT, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel5)
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        List<GioHangChiTiet> chiTiets = chiTietService.getList();
        if (chiTiets == null) {
    ...
    private void tblRowMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRowMouseClicked
        ...
        List<GioHangChiTiet> chiTiets = chiTietService.getList();
        GioHangChiTiet chiTiet = chiTiets.get(index);
        txtGHCT.setText(chiTiet.getIdGHCT());
        txtGH.setText(chiTiet.getIdGH());
    ...
    public void showData(List<GioHangChiTiet> chiTiets) {
        ...
        for (GioHangChiTiet ct : chiTiets) {
            Object[] row = new Object[]{
                ct.getIdGHCT(), ct.getIdGH(), ct.getIdCTSP(), ct.getSoLuong(),
    ...
    private javax.swing.JTextField txtGHCT;
