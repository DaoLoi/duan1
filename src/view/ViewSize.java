...
public class ViewSize extends javax.swing.JFrame {
    ...
    private void btnUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpActionPerformed
        ...
        List<Size> ses = service.getAll();
        Size s = ses.get(index);
        s.setTenSize(txtTen.getText());
        String idSize = txtId.getText();
        try {
            service.update(s, idSize);
    ...
    private void tblRowMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRowMouseClicked
        ...
        List<Size> ses = service.getAll();
        Size s = ses.get(index);
        txtId.setText(s.getIdSize());
        txtTen.setText(s.getTenSize());
