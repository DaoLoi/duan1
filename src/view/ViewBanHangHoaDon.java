...
import service.BanHangHoaDonService;
 ...
 * @author ASUS
 */
public class ViewBanHangHoaDon extends javax.swing.JFrame {

    private BanHangHoaDonService bhHDService;
    private DefaultTableModel dtm;
    
    /**
     * Creates new form ViewBanHangHoaDon
     */
    public void showData(List<BanHangHoaDon> bhHDs) {
        dtm.setRowCount(0);
        for (BanHangHoaDon hd : bhHDs) {
            Object[] row = new Object[]{
                hd.getIdHD(), hd.getTenNV(), hd.getTenKH(),
                hd.getNgayLap(), hd.getTrangThai() == 1 ? "Đã Thanh Toán" : "Chưa Thanh Toán"
            };
            dtm.addRow(row);
        }
    }
    public ViewBanHangHoaDon() {
        initComponents();
        bhHDService = new BanHangHoaDonService();
        dtm = (DefaultTableModel) tbHoaDon.getModel();
        String[] header = {"IdHD", "Tên nhân viên", "Tên khách hàng", "Ngày Lập", "Trạng Thái"};
        dtm.setColumnIdentifiers(header);
        showData(bhHDService.getAll());
    }
    ...
    private void initComponents() {
        ...
        btnLocKH = new javax.swing.JButton();
        ...
        btnLocKH.setText("Lọc Khách hàng");
        btnLocKH.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnLocKHActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addComponent(txtHoaDon, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                        .addGap(30, 30, 30)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtDenNgay, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel4)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnLocKH)
    ...
    private void btnLocHDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLocHDActionPerformed
        ...
        showData(bhHDService.timKiemHD(txtHoaDon.getText()));
    ...
    private void btnNgayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNgayActionPerformed
        // TODO add your handling code here:
        showData(bhHDService.timKiemNgay(txtTuNgay.getText(), txtDenNgay.getText()));
    }//GEN-LAST:event_btnNgayActionPerformed

    private void btnLocKHActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLocKHActionPerformed
        // TODO add your handling code here:
        showData(bhHDService.timKiemKH(txtKhachHang.getText()));
    }//GEN-LAST:event_btnLocKHActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewBanHangHoaDon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewBanHangHoaDon().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnLocKH;
