...
public class ChiTietSanPham {
    ...
    public ChiTietSanPham(String idctsp, String idsp, String idncc, String idlsp, String idghct, String size, String chatLieu, String donGia, int slTon, String ngayLap, String ngaySua, boolean trangThai) {
        this.idctsp = idctsp;
        this.idsp = idsp;
        this.idncc = idncc;
        this.idlsp = idlsp;
